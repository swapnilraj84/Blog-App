...
CSRF_TRUSTED_ORIGINS= ["https://blog-app-production-7a8a.up.railway.app/"]
...
SECRET_KEY = 'django-insecure-r!jvafep_58w4y0uxsq5u=2#mj2_^di)04r1bj-p73osf1$x45'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],    # Directory to store templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
